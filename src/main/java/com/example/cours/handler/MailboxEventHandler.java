package com.example.cours.handler;

import static com.example.cours.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.example.cours.PojaApplication;
import com.example.cours.PojaGenerated;
import com.example.cours.endpoint.EndpointConf;
import com.example.cours.endpoint.event.EventConf;
import com.example.cours.endpoint.event.consumer.EventConsumer;
import com.example.cours.endpoint.event.consumer.model.ConsumableEvent;
import com.example.cours.endpoint.event.consumer.model.ConsumableEventTyper;
