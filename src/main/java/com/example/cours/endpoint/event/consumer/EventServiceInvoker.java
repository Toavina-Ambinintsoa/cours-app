package com.example.cours.endpoint.event.consumer;

import com.example.cours.PojaGenerated;
import com.example.cours.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.example.cours.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.example.cours.service.event."
