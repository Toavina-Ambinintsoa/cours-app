package com.example.cours.endpoint.event.model;

import static com.example.cours.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.example.cours.PojaGenerated;
import com.example.cours.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "com.example.cours.event1";
  }
}
